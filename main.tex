...
Two additional frameworks---NIST AI RMF (AI 100-2e2025) and OWASP Top 10 for LLM Applications~\citep{owasp2024llm}---are included in our analysis but require manual extraction due to their PDF format. These frameworks provide complementary regulatory coverage but are not amenable to automated Git-based extraction.
