...
The discovery of adversarial vulnerabilities triggered an ongoing cycle of proposed defenses and increasingly sophisticated attacks designed to circumvent them---a pattern that has come to characterize adversarial machine learning research as an ``arms race'' between attackers and defenders~\citep{carlini2019evaluating}. Each new defense mechanism motivated adaptive attacks that exploited weaknesses in the defense strategy, which in turn motivated new defensive approaches. This adversarial co-evolution has shaped both the technical landscape and methodological standards of the field.
