...
\textbf{Dual coding:} Both coders independently code all 71 papers. Do NOT discuss papers until both are done.

\begin{enumerate}
    \item Open \texttt{extraction\_runs/run1/papers\_for\_coding\_71.csv}
    \item For each paper, fill in: G1, G2, G3, G4, G5, G6, T1, T2, Q1
    \item Use arXiv link to read the paper: \texttt{https://arxiv.org/abs/[arxiv\_id]}
    \item Estimated time: 15--20 minutes per paper
