...
\subsection{Not Included (Manual Extraction Required)}

\begin{tabular}{p{4cm}p{6cm}}
\toprule
\textbf{Framework} & \textbf{Reason} \\
\midrule
...
adoption\_lag\_months & Months from paper to adoption \\
selection\_reason & Why paper was selected \\
\bottomrule
\end{tabular}
...
\begin{enumerate}
    \item Open \texttt{papers\_for\_coding\_71.csv}
...
papers\_all.csv & Full 277 papers (for statistics) \\
